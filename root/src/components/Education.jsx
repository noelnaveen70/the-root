  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        <p>
          Our education programs provide resources and support for learners of all ages.
          We offer tutoring, workshops, and community classes to help individuals achieve their educational goals.
        </p>
      </main>
