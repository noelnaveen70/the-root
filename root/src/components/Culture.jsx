  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        <h1>Culture Programs</h1>
        <p>
          Our culture programs aim to celebrate and preserve the rich heritage of our community.
          Join us for workshops, events, and activities that promote cultural awareness and appreciation.
        </p>
      </main>
